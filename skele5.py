# importing packages
#7:30-11:04 3/26/2024 model and powerpoint
import tensorflow
...
#11-12:00 monday(emailed teacher) fiddled with model, fixed key issues
#10:55: 12:11 am wednesday(spoke to teacher about issues, discovered problem with non-nomrilizaed data range), 6:25-7:15
#9;50ish to 10;55 thursday, tried to find accuracy, did some reasearch on  differnet alorithims
#10:46-11;50 friday fixed accuracy problem, researcehd feature importance spoke to teacher about concerns reharding accuracy.
#Todo: normilization
...
for j in range(epochs):
    ...
    for i,(x_train,y_train) in enumerate(dataloader):
        ...
        #for feature importance https://www.kaggle.com/code/ceshine/feature-importance-from-a-pytorch-model
